...
var _exactInFilterModel = __webpack_require__(109);
...
var ExactFilter = function (_AbstractExactInFilte) {
    ...
    function ExactFilter(fieldId, fieldName, options, editable) {
        ...
        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ExactFilter).call(this, fieldId, fieldName, options, editable));
...
var InFilter = function (_AbstractExactInFilte) {
    ...
    function InFilter(fieldId, fieldName, options, editable) {
        ...
        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(InFilter).call(this, fieldId, fieldName, options, editable));
...
var _filterModel = __webpack_require__(4);
...
var AbstractExactInFilter = function (_ScFilter) {
    ...
    function AbstractExactInFilter(fieldId, fieldName, options, editable) {
        ...
        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(AbstractExactInFilter).call(this, fieldId, fieldName, options, editable));
    ...
    _createClass(AbstractExactInFilter, [{
        ...
        value: function update(configuration) {
            if (configuration.fieldId === this.fieldId && (configuration.type === _filterConst.FILTER_TYPE.EXACT || configuration.type === _filterConst.FILTER_TYPE.IN)) {
                ...
                if (configuration.overwriteMode) {
                    return configurationValues.length > 1 ? new _inFilterModel2.default(this.fieldId, this.fieldName, configuration.options, true) : new _exactFilterModel2.default(this.fieldId, this.fieldName, configuration.options, true);
                } else {
                    ...
                    if (configuration.options.values.length === 0) {
                        ...
                        return configuration.options.values.length > 1 ? new _inFilterModel2.default(this.fieldId, this.fieldName, configuration.options, true) : new _exactFilterModel2.default(this.fieldId, this.fieldName, configuration.options, true);
                    }
                }
            }
        ...
        value: function setValues(newOptions) {
            if (newOptions.values.length > 1) {
                return new _inFilterModel2.default(this.fieldId, this.fieldName, newOptions, true);
            } else if (newOptions.values.length) {
                return new _exactFilterModel2.default(this.fieldId, this.fieldName, newOptions, true);
            }
            return null;
        }
    }]);
...
var _accordionAnimation = __webpack_require__(129);
...
var _accordion = __webpack_require__(132);
...
var _badgeComponent = __webpack_require__(134);
...
var _datePickerComponent = __webpack_require__(135);
...
var _dropdownMenuComponent = __webpack_require__(138);
...
var _dropdownComponent = __webpack_require__(140);
...
var _filterBarComponent = __webpack_require__(142);
...
var _filterItemComponent = __webpack_require__(144);
...
var _filterRangeComponent = __webpack_require__(146);
...
var _filterValueComponent = __webpack_require__(148);
...
var _filterListComponent = __webpack_require__(150);
...
var _filterMonitorComponent = __webpack_require__(152);
...
var _horizontalBarchartComponent = __webpack_require__(154);
...
var _listEditorComponent = __webpack_require__(156);
...
var _slidableComponent = __webpack_require__(158);
...
var _splitterComponent = __webpack_require__(160);
...
var _tabsItem = __webpack_require__(162);
...
var _verticalBarchartComponent = __webpack_require__(166);
...
var _filterService = __webpack_require__(169);
...
var _accordionItem = __webpack_require__(131);
...
var _accordion = __webpack_require__(133);
...
var _datePickerController = __webpack_require__(136);
...
var _pikadayOverride = __webpack_require__(137);
            ...
            if (this._o && this._o.controller) {
                (function () {
                    ...
                    if (_this._d) {
                        ...
                        if (!_this.doNotCloseDp || _this.doNotCloseDp === false) {
...
var _dropdownMenuController = __webpack_require__(139);
...
var _dropdownController = __webpack_require__(141);
...
var _filterBarController = __webpack_require__(143);
...
var _filterItemController = __webpack_require__(145);
...
var ScFilterItemCtrl = function () {
    ...
    _createClass(ScFilterItemCtrl, [{
        ...
        value: function renderValue(value) {
            var formattedValue = this.renderValueFn({ colId: this.filter.fieldId, value: value });
...
var _filterRangeController = __webpack_require__(147);
...
var _filterValueController = __webpack_require__(149);
...
var ScFilterValueCtrl = function () {
    ...
    _createClass(ScFilterValueCtrl, [{
        ...
        key: '_initEmptyValue',
        value: function _initEmptyValue() {
...
var _filterListController = __webpack_require__(151);
...
var _filterMonitorController = __webpack_require__(153);
...
var _horizontalBarchartController = __webpack_require__(155);
    ...
    _createClass(ScHorizontalBarchartCtrl, [{
        ...
        value: function $onInit() {
            ...
            this.tooltip = _d2.default.tip().attr('class', 'horizontal-barchart-cls d3-tip').offset([-10, 0]).html(function (primaryDatum, index) {
                ...
                var tooltipValue = _this.primaryData[index].formattedValue;
        ...
        value: function _configureScales(statData) {
            ...
            this.xScale.domain([0, _d2.default.max(statData, function (data) {
                return _this2._getPrimaryValue(data);
            })]);
            this.yScale.domain(statData.map(function (data) {
                return _this2._getKey(data);
            }));
        }
    }, {
        key: '_initAxes',
        ...
        value: function _drawHoverBars(statData, width) {
            ...
            this.svg.selectAll('g.bg-rect').data(statData).enter().append('g').attr('class', 'hover').attr('transform', function (d) {
                return 'translate(0, ' + (_this5.yScale(_this5._getKey(d)) - 2) + ')';
                ...
                _this5.onClick({ eventObject: { eventKeyPressed: eventKeyPressed, item: _extends({}, d) } });
            });
        }
    }, {
...
var _listEditorController = __webpack_require__(157);
...
var _slidableController = __webpack_require__(159);
...
var _splitterController = __webpack_require__(161);
...
var _tabsItem = __webpack_require__(163);
...
var _verticalBarchartController = __webpack_require__(167);
...
var _rangeFilterModel = __webpack_require__(171);

var _rangeFilterModel2 = _interopRequireDefault(_rangeFilterModel);

var _patternFilterModel = __webpack_require__(170);
                ...
                switch (configuration.type) {
                    ...
                    case _filterConst.FILTER_TYPE.IN:
                        ...
                        if (configuration.options.values && configuration.options.values.length > 0) {
                            ...
                            return configuration.options.values.length > 1 ? new _inFilterModel2.default(configuration.fieldId, configuration.fieldName, configuration.options, true) : new _exactFilterModel2.default(configuration.fieldId, configuration.fieldName, configuration.options, true);
                        }
                        break;
                    ...
                    case _filterConst.FILTER_TYPE.PATTERN:
                        return new _patternFilterModel2.default(configuration.fieldId, configuration.fieldName, configuration.options);
...
var _filterModelFactory = __webpack_require__(168);
...
var FilterService = function () {
    ...
    _createClass(FilterService, [{
        ...
        value: function addFilterValue(actualFilters, configuration) {
            var filter = configuration.filter;
            var newValue = configuration.newValue;
        ...
        value: function updateFilterValue(actualFilters, configuration) {
            var filter = configuration.filter;
            var oldValue = configuration.oldValue;
            var newValue = configuration.newValue;
...
var PatternFilter = function (_ScFilter) {
    ...
    function PatternFilter(fieldId, fieldName, options, editable) {
        ...
        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(PatternFilter).call(this, fieldId, fieldName, options, editable));
    ...
    _createClass(PatternFilter, [{
        ...
        value: function setValues(newOptions) {
            if (newOptions.values.length) {
                return new PatternFilter(this.fieldId, this.fieldName, newOptions);
            }
            return null;
        }
    }, {
...
var RangeFilter = function (_ScFilter) {
    ...
    function RangeFilter(fieldId, fieldName, options, editable) {
        _classCallCheck(this, RangeFilter);

        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(RangeFilter).call(this, fieldId, fieldName, options, editable));
    ...
    _createClass(RangeFilter, [{
        ...
        value: function getLabel(value) {
            if (value.min !== value.max) {
                return !this.options.isSingleValueRange ? "[" + value.min + ", " + value.max + "[" : "[" + value.min + ", " + value.max + "]";
            }
            return "[" + value.min + "]";
        }
    }, {
            ...
            values.forEach(function (value) {
                ...
                if (index > -1) {
                    ...
                    if (_this6.inAnotherRange(clone, value) && !_this6.options.isSingleValueRange) {
                        ...
                        var newRanges = [{ min: clone[rangeToUpdate].min, max: value.min }, {
                            min: value.max,
