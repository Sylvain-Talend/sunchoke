...
var ExactFilter = function (_AbstractExactInFilte) {
    ...
    function ExactFilter(fieldId, fieldName, options) {
        _classCallCheck(this, ExactFilter);

        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ExactFilter).call(this, fieldId, fieldName, options, true));
...
var _exactFilterModel = __webpack_require__(4);
...
var InFilter = function (_AbstractExactInFilte) {
    ...
    function InFilter(fieldId, fieldName, options) {
        _classCallCheck(this, InFilter);

        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(InFilter).call(this, fieldId, fieldName, options, true));
    ...
    _createClass(InFilter, [{
        ...
        value: function toDSL() {
            ...
            this.options.values.forEach(function (value, index) {
                valueToString += index !== _this3.options.values.length - 1 ? "'" + value + "', " : "'" + value + "'";
            });
...
var _filterModel = __webpack_require__(109);
    ...
    _createClass(AbstractExactInFilter, [{
        ...
        value: function update(configuration) {
            if (configuration.fieldId === this.fieldId && (configuration.type === _filterConst.FILTER_TYPE.EXACT || configuration.type === _filterConst.FILTER_TYPE.IN)) {
                ...
                if (configuration.overwriteMode) {
                    return configurationValues.length > 1 ? new _inFilterModel2.default(this.fieldId, this.fieldName, configuration.options) : new _exactFilterModel2.default(this.fieldId, this.fieldName, configuration.options);
                } else {
                    ...
                    if (configuration.options.values.length === 0) {
                        ...
                        return configuration.options.values.length > 1 ? new _inFilterModel2.default(this.fieldId, this.fieldName, configuration.options) : new _exactFilterModel2.default(this.fieldId, this.fieldName, configuration.options);
                    }
                }
            }
        ...
        value: function setValues(newOptions) {
            if (newOptions.values.length > 1) {
                return new _inFilterModel2.default(this.fieldId, this.fieldName, newOptions);
            } else if (newOptions.values.length) {
                return new _exactFilterModel2.default(this.fieldId, this.fieldName, newOptions);
            }
            return null;
        }
    }]);
...
angular.module(MODULE_NAME, []).component('scFilterItem', _filterItemComponent2.default);
...
var _filterSearchComponent = __webpack_require__(151);

var _filterSearchComponent2 = _interopRequireDefault(_filterSearchComponent);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var MODULE_NAME = 'talend.sunchoke.filter-search';

angular.module(MODULE_NAME, []).component('scFilterSearch', _filterSearchComponent2.default);
...
var _horizontalBarchartComponent = __webpack_require__(153);
...
var _resizableInputDirective = __webpack_require__(155);
...
var ScDropdownCtrl = function () {
    ...
    _createClass(ScDropdownCtrl, [{
        ...
        value: function _positionVerticalMenu() {
            ...
            var freeSpaceBottom = windowSize - positionAction.bottom;
...
var ScFilterItemCtrl = function () {
    ScFilterItemCtrl.$inject = ["$translate"];
    function ScFilterItemCtrl($translate) {
        'ngInject';
    ...
    _createClass(ScFilterItemCtrl, [{
        ...
        value: function edit(index, value) {
            var filterValue = this.filterValues[index];
            if (filterValue) {
...
var FilterListCtrl = function () {
    ...
    _createClass(FilterListCtrl, [{
        key: 'changeFilter',
        value: function changeFilter(filter, value) {
            this.onFilterRemoveValue({ filter: filter, value: value });
        }
    }, {
        key: 'removeFilter',
...
var _filterSearchController = __webpack_require__(152);

var _filterSearchController2 = _interopRequireDefault(_filterSearchController);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var ScFilterSearchComponent = {
    ...
    controller: _filterSearchController2.default

};

exports.default = ScFilterSearchComponent;
...
exports.default = ScFilterSearchCtrl;
function ScFilterSearchCtrl() {}
...
var _horizontalBarchartController = __webpack_require__(154);
...
var _d3Tip = __webpack_require__(6);
                ...
                switch (configuration.type) {
                    ...
                    case _filterConst.FILTER_TYPE.IN:
                        ...
                        if (configuration.options.values && configuration.options.values.length > 0) {
                            ...
                            return configuration.options.values.length > 1 ? new _inFilterModel2.default(configuration.fieldId, configuration.fieldName, configuration.options) : new _exactFilterModel2.default(configuration.fieldId, configuration.fieldName, configuration.options);
                        }
                        break;
...
var _filterSearchModule = __webpack_require__(120);

var _filterSearchModule2 = _interopRequireDefault(_filterSearchModule);
