...
var ScFilter = function () {
    function ScFilter(fieldId, fieldName, options, editable) {
        _classCallCheck(this, ScFilter);
    ...
    _createClass(ScFilter, [{
        key: "toggleFilterValues",
        value: function toggleFilterValues(values) {
            var _this = this;

            var clone = this.options.values.slice(0);
            var newFilterValue = [];

            values.forEach(function (value) {
                var index = clone.findIndex(function (filterValue) {
                    return _this._compareValues(value, filterValue) === 0;
                });
                if (index > -1) {
            ...
            clone.push.apply(clone, newFilterValue);
            clone.sort(this._compareValues);
            return clone;
        }
    }, {
        key: "_compareValues",
        value: function _compareValues(value, valueToCompare) {
        ...
        value: function removeValue(value) {
            ...
            var newValues = this.options.values.filter(function (filterValue) {
        ...
        key: "updateValue",
        value: function updateValue(oldValue, newValue) {
            var _this2 = this;

            var options = this.options;
            var newValues = this.options.values.slice(0);
            var updateIndex = newValues.findIndex(function (filterValue) {
                return _this2._compareValues(filterValue, oldValue) === 0;
            });
        ...
        value: function toggleValue(value) {
            var options = this.options;
            var newValues = this.toggleFilterValues([value]);
        ...
        key: "fromDSL",
        value: function fromDSL() {}
    }]);

    return ScFilter;
}();

exports.default = ScFilter;
...
var _inFilterModel = __webpack_require__(6);

var _inFilterModel2 = _interopRequireDefault(_inFilterModel);

var _filterConst = __webpack_require__(2);

var _exactInFilterModel = __webpack_require__(116);

var _exactInFilterModel2 = _interopRequireDefault(_exactInFilterModel);
...
var ExactFilter = function (_AbstractExactInFilte) {
    _inherits(ExactFilter, _AbstractExactInFilte);

    function ExactFilter(fieldId, fieldName, options, editable) {
        _classCallCheck(this, ExactFilter);

        var _this = _possibleConstructorReturn(this, (ExactFilter.__proto__ || Object.getPrototypeOf(ExactFilter)).call(this, fieldId, fieldName, options, editable));

        _this.editable = options.values[0].length > 1 ? editable : false;
        _this.sign = '=';
        return _this;
    }
    ...
    _createClass(ExactFilter, [{
        ...
        value: function toDSL() {
            ...
            if (typeof this.options.values[0] === 'string') {
                dsl = this.options.values[0] !== "" ? "(" + this.fieldId + "='" + this.options.values[0] + "')" : "(" + this.fieldId + " is empty)";
            } else {
                dsl = this.options.values[0] !== "" ? "(" + this.fieldId + "=" + this.options.values[0] + ")" : "(" + this.fieldId + " is empty)";
            }
            return dsl;
...
var _exactFilterModel = __webpack_require__(5);

var _exactFilterModel2 = _interopRequireDefault(_exactFilterModel);
...
var InFilter = function (_AbstractExactInFilte) {
    _inherits(InFilter, _AbstractExactInFilte);

    function InFilter(fieldId, fieldName, options, editable) {
        _classCallCheck(this, InFilter);

        var _this = _possibleConstructorReturn(this, (InFilter.__proto__ || Object.getPrototypeOf(InFilter)).call(this, fieldId, fieldName, options, editable));

        _this.sign = 'in';
        return _this;
    }

    _createClass(InFilter, [{
        key: "toDSL",
        value: function toDSL() {
            var _this2 = this;
            ...
            this.options.values.forEach(function (value, index) {
                if (value || value === false) {
                    if (typeof value === 'string') {
                        valueToString += index !== _this2.options.values.length - 1 ? "'" + value + "', " : "'" + value + "'";
                    } else {
                        valueToString += index !== _this2.options.values.length - 1 ? value + ", " : value;
                    }
                } else {
                    emptyString += _this2.fieldId + " is empty or ";
                }
            });
...
var _filterModel = __webpack_require__(3);
...
var AbstractExactInFilter = function (_ScFilter) {
    _inherits(AbstractExactInFilter, _ScFilter);

    function AbstractExactInFilter(fieldId, fieldName, options, editable) {
        _classCallCheck(this, AbstractExactInFilter);

        var _this = _possibleConstructorReturn(this, (AbstractExactInFilter.__proto__ || Object.getPrototypeOf(AbstractExactInFilter)).call(this, fieldId, fieldName, options, editable));

        _this.options.values.sort(_this._compareValues);
        return _this;
    }

    _createClass(AbstractExactInFilter, [{
        key: 'update',
        value: function update(configuration) {
            if (configuration.fieldId === this.fieldId && (configuration.type === _filterConst.FILTER_TYPE.EXACT || configuration.type === _filterConst.FILTER_TYPE.IN)) {

                var configurationValues = configuration.options.values;

                if (configuration.overwriteMode) {
                    return configurationValues.length > 1 ? new _inFilterModel2.default(this.fieldId, this.fieldName, configuration.options, configuration.editable) : new _exactFilterModel2.default(this.fieldId, this.fieldName, configuration.options, configuration.editable);
                } else {

                    var newValue = this.toggleFilterValues(configuration.options.values);
                    configuration.options.values = newValue;

                    if (configuration.options.values.length === 0) {
                        return null;
                    } else {
                        return configuration.options.values.length > 1 ? new _inFilterModel2.default(this.fieldId, this.fieldName, configuration.options, configuration.editable) : new _exactFilterModel2.default(this.fieldId, this.fieldName, configuration.options, configuration.editable);
                    }
                }
            }
        ...
        key: 'setValues',
        value: function setValues(newOptions) {
            if (newOptions.values.length > 1) {
                return new _inFilterModel2.default(this.fieldId, this.fieldName, newOptions, this.editable);
            } else if (newOptions.values.length) {
                return new _exactFilterModel2.default(this.fieldId, this.fieldName, newOptions, this.editable);
            }
            return null;
        }
    }]);

    return AbstractExactInFilter;
}(_filterModel2.default);

exports.default = AbstractExactInFilter;
...
var _accordionAnimation = __webpack_require__(137);

var _accordionAnimation2 = _interopRequireDefault(_accordionAnimation);

var _accordionItem = __webpack_require__(138);

var _accordionItem2 = _interopRequireDefault(_accordionItem);

var _accordion = __webpack_require__(140);
...
var _badgeComponent = __webpack_require__(142);

var _badgeComponent2 = _interopRequireDefault(_badgeComponent);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var MODULE_NAME = 'talend.sunchoke.badge';

_angular2.default.module(MODULE_NAME, []).component('scTalendBadge', _badgeComponent2.default);
...
var _datePickerComponent = __webpack_require__(143);

var _datePickerComponent2 = _interopRequireDefault(_datePickerComponent);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var MODULE_NAME = 'talend.sunchoke.date-picker';

_angular2.default.module(MODULE_NAME, []).component('scDatePicker', _datePickerComponent2.default);
...
var _dropdownMenuComponent = __webpack_require__(146);
...
var _dropdownComponent = __webpack_require__(148);
...
var _filterBarComponent = __webpack_require__(150);

var _filterBarComponent2 = _interopRequireDefault(_filterBarComponent);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var MODULE_NAME = 'talend.sunchoke.filter-bar';

angular.module(MODULE_NAME, []).component('scFilterBar', _filterBarComponent2.default);
...
var _filterItemComponent = __webpack_require__(152);

var _filterItemComponent2 = _interopRequireDefault(_filterItemComponent);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var MODULE_NAME = 'talend.sunchoke.filter-item';

angular.module(MODULE_NAME, ['talend.sunchoke.filter-item-value', 'talend.sunchoke.badge']).component('scFilterItem', _filterItemComponent2.default);
...
var _filterRangeComponent = __webpack_require__(154);

var _filterRangeComponent2 = _interopRequireDefault(_filterRangeComponent);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var MODULE_NAME = 'talend.sunchoke.filter-item-range';

angular.module(MODULE_NAME, []).component('scFilterRange', _filterRangeComponent2.default);
...
var _filterValueComponent = __webpack_require__(156);

var _filterValueComponent2 = _interopRequireDefault(_filterValueComponent);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var MODULE_NAME = 'talend.sunchoke.filter-item-value';

angular.module(MODULE_NAME, []).component('scFilterValue', _filterValueComponent2.default);
...
var _filterListComponent = __webpack_require__(158);

var _filterListComponent2 = _interopRequireDefault(_filterListComponent);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var MODULE_NAME = 'talend.sunchoke.filter-list';

angular.module(MODULE_NAME, []).component('scFilterList', _filterListComponent2.default);
...
var _filterMonitorComponent = __webpack_require__(160);

var _filterMonitorComponent2 = _interopRequireDefault(_filterMonitorComponent);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var MODULE_NAME = 'talend.sunchoke.filter-monitor';

angular.module(MODULE_NAME, []).component('scFilterMonitor', _filterMonitorComponent2.default);
...
var _horizontalBarchartComponent = __webpack_require__(162);

var _horizontalBarchartComponent2 = _interopRequireDefault(_horizontalBarchartComponent);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var MODULE_NAME = 'talend.sunchoke.horizontal-barchart';

_angular2.default.module(MODULE_NAME, []).component('scHorizontalBarchart', _horizontalBarchartComponent2.default);
exports.default = MODULE_NAME;
...
var _listEditorComponent = __webpack_require__(164);

var _listEditorComponent2 = _interopRequireDefault(_listEditorComponent);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var MODULE_NAME = 'talend.sunchoke.list-editor';

_angular2.default.module(MODULE_NAME, []).component('scListEditor', _listEditorComponent2.default);
...
var _qualityBarComponent = __webpack_require__(166);

var _qualityBarComponent2 = _interopRequireDefault(_qualityBarComponent);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var MODULE_NAME = 'talend.sunchoke.quality-bar';

_angular2.default.module(MODULE_NAME, []).component('scQualityBar', _qualityBarComponent2.default);
...
var _slidableComponent = __webpack_require__(168);
...
var _splitterComponent = __webpack_require__(170);
...
var _tabsItem = __webpack_require__(172);
...
var _verticalBarchartComponent = __webpack_require__(176);

var _verticalBarchartComponent2 = _interopRequireDefault(_verticalBarchartComponent);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var MODULE_NAME = 'talend.sunchoke.vertical-barchart';

_angular2.default.module(MODULE_NAME, []).component('scVerticalBarchart', _verticalBarchartComponent2.default);
...
var _filterService = __webpack_require__(179);

var _filterService2 = _interopRequireDefault(_filterService);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var MODULE_NAME = 'talend.sunchoke.services.filter';

_angular2.default.module(MODULE_NAME, []).service('FilterService', _filterService2.default);
...
var _accordionItem = __webpack_require__(139);
...
exports.default = ScTalendBadgeComponent;
...
var _datePickerController = __webpack_require__(144);

var _datePickerController2 = _interopRequireDefault(_datePickerController);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var ScDatePickerComponent = {
    ...
    controller: _datePickerController2.default
};

exports.default = ScDatePickerComponent;
...
var _pikadayOverride = __webpack_require__(145);

var _pikadayOverride2 = _interopRequireDefault(_pikadayOverride);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

var ScDatePickerCtrl = function () {
  ScDatePickerCtrl.$inject = ["$element", "$timeout"];
  function ScDatePickerCtrl($element, $timeout) {
    'ngInject';

    _classCallCheck(this, ScDatePickerCtrl);
  ...
  _createClass(ScDatePickerCtrl, [{
    key: '$onInit',
    value: function $onInit() {

      var input = this.$element.find('input')[0];

      var container = this.$element.find('div')[2];
      ...
      this.pikaday = new _pikadayOverride2.default(config);
    }
  }, {
    key: '$onDestroy',
    ...
    value: function onCloseHandler() {
      ...
      if (this._o && this._o.controller) {
        (function () {
          ...
          var actualController = _this._o.controller;

          if (!_this.isSetDate) {
            actualController.$timeout(function () {
            ...
            if (_this._d) {
              ...
              if (_this.textErrorDate !== null) {
                actualController.ngModel = _this.textErrorDate;
              } else {

                actualController.$timeout(function () {
                  actualController.ngModel = _this._d.getTime();
                });
              }
            } else {
    ...
    key: 'setFocus',
    value: function setFocus(focusState) {
      this.focusState = focusState;
    }
  }]);

  return ScDatePickerCtrl;
}();

exports.default = ScDatePickerCtrl;
...
(function (root, factory) {
    ...
    var hasMoment = typeof moment === 'function',
        ...
        container += '<table cellpadding="0" cellspacing="0" class="pika-table" role="grid" aria-labelledby="' + randId + '">' + renderHead(opts) + renderBody(data) + '</table>';
        if (opts.noneButton) {
            container += '<button class="ghost-button">' + opts.i18n.none + '</button>';
        }
        container += '</div>';
        return container;
    },
        ...
        self._onMouseDown = function (e) {
            ...
            if (!hasClass(target, 'is-disabled')) {
                if (hasClass(target, 'pika-button') && !hasClass(target, 'is-empty') && !hasClass(target.parentNode, 'is-disabled')) {
                    ...
                    self.nextMonth();
                } else if (hasClass(target, 'ghost-button')) {
                    self.setDate(null);
                    if (opts.bound) {
                        sto(function () {
                            self.hide();
...
var _dropdownMenuController = __webpack_require__(147);
...
var _dropdownController = __webpack_require__(149);
...
var ScDropdownCtrl = function () {
    ...
    _createClass(ScDropdownCtrl, [{
        ...
        value: function _positionVerticalMenu() {
            ...
            var positionContent = this.content[0].getBoundingClientRect();
            var windowSize = this.window[0].innerHeight;

            var freeSpaceBottom = windowSize - positionAction.bottom - this.offsetBorder;
            var freeSpaceTop = positionContent.top - this.offsetBorder;
            ...
            if (freeSpaceBottom > freeSpaceTop) {
                ...
                if (positionContent.top + heightContent + this.offsetBorder >= windowSize) {
                    var newContentSize = heightContent - (positionContent.top + heightContent + this.offsetBorder - windowSize);
                ...
                if (heightContent + this.offsetBorder > positionAction.top) {
                    var _newContentSize = positionAction.top - this.offsetBorder - CARRET_HEIGHT;
                    this.content.children().css('height', _newContentSize + 'px');
...
var _filterBarController = __webpack_require__(151);

var _filterBarController2 = _interopRequireDefault(_filterBarController);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var ScFilterBarComponent = {
    ...
    controller: _filterBarController2.default
};

exports.default = ScFilterBarComponent;
...
var ScFilterBarCtrl = function () {
    function ScFilterBarCtrl() {
        _classCallCheck(this, ScFilterBarCtrl);
    }

    _createClass(ScFilterBarCtrl, [{
        key: "removeFilter",
        ...
        key: "editFilter",
        value: function editFilter(filter, newValue, oldValue) {
            this.onFilterEdit({ filter: filter, newValue: newValue, oldValue: oldValue });
        }
    }, {
        key: "removeFilterValue",
        value: function removeFilterValue(filter, value) {
            this.onFilterRemoveValue({ filter: filter, value: value });
        }
    }, {
        key: "renderValue",
        value: function renderValue(colId, value) {
            return this.renderValueFn({ colId: colId, value: value });
        }
    }]);

    return ScFilterBarCtrl;
}();

exports.default = ScFilterBarCtrl;
...
var _filterItemController = __webpack_require__(153);

var _filterItemController2 = _interopRequireDefault(_filterItemController);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var ScFilterItemComponent = {
    ...
    controller: _filterItemController2.default,
    bindings: {
        filter: '<',
        editable: '<',
        onEdit: '&',
...
exports.default = ScFilterItemComponent;
...
var ScFilterItemCtrl = function () {
    function ScFilterItemCtrl() {
        _classCallCheck(this, ScFilterItemCtrl);
    }

    _createClass(ScFilterItemCtrl, [{
        key: '$onInit',
        value: function $onInit() {
        ...
        value: function $onChanges(changes) {
            var model = changes.filter;
            if (model) {
                var newModel = model.currentValue;
                if (newModel) {
            ...
            if (this.filter) {
                switch (this.filter.sign) {
                    ...
                    case '=':
                        this.sign = ' = ';
                        break;
                    case _filterConst.FILTER_TYPE.INSIDE_RANGE:
                        this.sign = ' in ';
                        break;
                    default:
                        this.sign = ' : ';
        ...
        key: 'edit',
        value: function edit(index, newValue) {

            var oldValue = this.filterValues[index];
        ...
        value: function remove(indexToRemove) {
            var valueToDelete = this.filterValues.filter(function (value, index) {
    ...
    return ScFilterItemCtrl;
}();

exports.default = ScFilterItemCtrl;
...
var _filterRangeController = __webpack_require__(155);

var _filterRangeController2 = _interopRequireDefault(_filterRangeController);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var ScFilterRangeComponent = {
    ...
    controller: _filterRangeController2.default,
    bindings: {
        filterValue: '<',
        onEdit: '&',
        removable: '<',
...
exports.default = ScFilterRangeComponent;
...
var ScFilterRangeCtrl = function () {
    ScFilterRangeCtrl.$inject = ["$element"];
    function ScFilterRangeCtrl($element) {
        'ngInject';

        _classCallCheck(this, ScFilterRangeCtrl);

        this.$element = $element;
    }

    _createClass(ScFilterRangeCtrl, [{
        key: '$onInit',
        value: function $onInit() {
            this.initInput();
        }
    ...
    return ScFilterRangeCtrl;
}();

exports.default = ScFilterRangeCtrl;
...
var _filterValueController = __webpack_require__(157);

var _filterValueController2 = _interopRequireDefault(_filterValueController);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var ScFilterValueComponent = {
    ...
    controller: _filterValueController2.default,
    bindings: {
        filterValue: '<',
        onEdit: '&',
        removable: '<',
...
exports.default = ScFilterValueComponent;
...
var ScFilterValueCtrl = function () {
    ScFilterValueCtrl.$inject = ["$element"];
    function ScFilterValueCtrl($element) {
        'ngInject';

        _classCallCheck(this, ScFilterValueCtrl);

        this.$element = $element;
    }

    _createClass(ScFilterValueCtrl, [{
        key: '$onInit',
        value: function $onInit() {
        ...
        key: 'removeEmptyValue',
        value: function removeEmptyValue() {
    ...
    return ScFilterValueCtrl;
}();

exports.default = ScFilterValueCtrl;
...
var _filterListController = __webpack_require__(159);

var _filterListController2 = _interopRequireDefault(_filterListController);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var ScFilterListComponent = {
    ...
    controller: _filterListController2.default,
    bindings: {
        filters: '=',
        onFilterRemoveValue: '&',
        onFilterRemove: '&',
...
exports.default = ScFilterListComponent;
...
var FilterListCtrl = function () {
    function FilterListCtrl() {
        _classCallCheck(this, FilterListCtrl);
    }

    _createClass(FilterListCtrl, [{
        key: "editFilter",
        value: function editFilter(filter, newValue, oldValue) {
            this.onFilterEdit({ filter: filter, newValue: newValue, oldValue: oldValue });
        }
...
exports.default = FilterListCtrl;
...
var _filterMonitorController = __webpack_require__(161);

var _filterMonitorController2 = _interopRequireDefault(_filterMonitorController);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var ScFilterMonitorComponent = {
    ...
    controller: _filterMonitorController2.default,
    bindings: {
        filters: '=',
        onToogle: '&',
        nbLines: '<',
...
exports.default = ScFilterMonitorComponent;
...
var FilterMonitorCtrl = function FilterMonitorCtrl() {
  _classCallCheck(this, FilterMonitorCtrl);
};

exports.default = FilterMonitorCtrl;
...
var _horizontalBarchartController = __webpack_require__(163);

var _horizontalBarchartController2 = _interopRequireDefault(_horizontalBarchartController);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var ScHorizontalBarchartComponent = {
    bindings: {
        onClick: '&',
        keyField: '@',
        keyLabel: '@',
    ...
    controller: _horizontalBarchartController2.default
};

exports.default = ScHorizontalBarchartComponent;
...
var _d3Tip = __webpack_require__(7);
...
var ScHorizontalBarchartCtrl = function () {
    ScHorizontalBarchartCtrl.$inject = ["$timeout", "$attrs", "$element"];
    function ScHorizontalBarchartCtrl($timeout, $attrs, $element) {
        'ngInject';

        _classCallCheck(this, ScHorizontalBarchartCtrl);
    ...
    _createClass(ScHorizontalBarchartCtrl, [{
        key: '$onInit',
        value: function $onInit() {
            var _this = this;
            ...
            this.tooltip = _d2.default.tip().attr('class', 'horizontal-barchart-cls d3-tip').offset([-10, 0]).html(function (primaryDatum, index) {

                var tooltipValue = _this.primaryData[index][_this.keyField];

                var toolTipFounded = _this.secondaryData.find(function (obj) {
                    return obj[_this.keyField].value === tooltipValue.value;
                });

                return _this.tooltipContent({
                    keyLabel: _this.keyLabel,
                    key: _this._getKey(primaryDatum),
                    primaryValue: _this._getPrimaryValue(primaryDatum),
                    secondaryValue: toolTipFounded ? _this._getSecondaryValue(toolTipFounded) : "0"
                });
            });
        }
    }, {
        ...
        value: function $onChanges(changesObj) {
            ...
            if (firstDataHasChanged && firstVisuData) {
                ...
                _d2.default.selectAll('.horizontal-barchart-cls.d3-tip').remove();
        ...
        key: '_sanitizedSecondaryData',
        value: function _sanitizedSecondaryData(secondaryData) {
            var _this2 = this;
            ...
            var primaryDataClone = JSON.parse(JSON.stringify(this.primaryData));

            return primaryDataClone.map(function (primaryDatum) {
                var secondaryDatum = secondaryData.find(function (secondaryDatum) {
                    return _this2._getKey(primaryDatum) === _this2._getKey(secondaryDatum);
                });
                if (!secondaryDatum) {
                    delete primaryDatum[_this2.primaryValueField];
                    primaryDatum[_this2.secondaryValueField] = 0;
                    return primaryDatum;
                } else {
        ...
        key: '_getKey',
        value: function _getKey(data) {

            return data[this.keyField].value;
        }
    }, {
        key: '_getLabel',
        value: function _getLabel(data) {

            return data[this.keyField].label;
        }
    }, {
        key: '_getPrimaryValue',
        value: function _getPrimaryValue(data) {
            return data[this.primaryValueField];
        }
    }, {
        key: '_getSecondaryValue',
        value: function _getSecondaryValue(data) {
            return data[this.secondaryValueField];
        }
    }, {
        key: '_getPrimaryClassName',
        value: function _getPrimaryClassName() {
            return this.primaryBarClass ? this.primaryBarClass : 'transparentBar';
        }
    }, {
        key: '_getSecondaryClassName',
        value: function _getSecondaryClassName() {
            return this.secondaryBarClass ? this.secondaryBarClass : 'blueBar';
        }
    }, {
        key: '_initScales',
        value: function _initScales(width, height) {
            this.xScale = _d2.default.scale.linear().range([0, width]);
            this.yScale = _d2.default.scale.ordinal().rangeBands([0, height], 0.18);
        }
    }, {
        key: '_configureScales',
        value: function _configureScales(statData) {
            var _this3 = this;

            this.xScale.domain([0, _d2.default.max(statData, function (data) {
                return _this3._getPrimaryValue(data);
            })]);
            this.yScale.domain(statData.map(function (data) {
                return _this3._getKey(data);
            }));
        }
    }, {
        key: '_initAxes',
        value: function _initAxes(height) {
            var ticksThreshold;
            ...
            this.xAxis = _d2.default.svg.axis().scale(this.xScale).tickFormat(_d2.default.format(',d')).orient('top').tickSize(-height).ticks(ticksNbre);
        }
    }, {
        key: '_createContainer',
        value: function _createContainer(width, height) {
            this.svg = _d2.default.select(this.containerId).append('svg').attr('class', 'horizontal-barchart-cls').attr('width', width).attr('height', height).append('g').attr('transform', 'translate(' + this.margin.left + ',' + this.margin.top + ')');
            this.svg.call(this.tooltip);
        }
    }, {
        key: '_drawGrid',
        value: function _drawGrid() {
            this.svg.append('g').attr('class', 'grid').call(this.xAxis).selectAll('.tick text').style('text-anchor', 'middle');
        }
    }, {
        key: '_createBarsContainers',
        value: function _createBarsContainers() {
            this.svg.append('g').attr('class', 'primaryBar');

            this.svg.append('g').attr('class', 'secondaryBar');
        }
    }, {
        key: '_adaptToMinHeight',
        value: function _adaptToMinHeight(realWidth) {
            return realWidth > 0 && realWidth < BAR_MIN_WIDTH ? BAR_MIN_WIDTH : realWidth;
        }
    }, {
        key: '_drawBars',
        value: function _drawBars(containerClassName, statData, getValue, barClassName) {
            var _this4 = this;

            var bars = this.svg.select('.' + containerClassName).selectAll('.' + barClassName).data(statData, function (d) {
                return _this4._getKey(d);
            });

            bars.enter().append('rect').attr('class', barClassName).attr('transform', function (d) {
                return 'translate(0,' + _this4.yScale(_this4._getKey(d)) + ')';
            }).attr('height', this.yScale.rangeBand()).attr('width', this.xScale(0)).transition().delay(function (d, i) {
                return i * 30;
            }).attr('width', function (d) {
                var realWidth = _this4.xScale(getValue(d));
                return _this4._adaptToMinHeight(realWidth);
            });
        ...
        key: '_drawKeysLabels',
        value: function _drawKeysLabels(statData, width) {
            var _this5 = this;

            this.svg.append('g').attr('class', 'labels').selectAll('label').data(statData).enter().append('foreignObject').attr('width', width).attr('height', this.yScale.rangeBand()).attr('transform', function (d) {
                return 'translate(0,' + _this5.yScale(_this5._getKey(d)) + ')';
            }).append('xhtml:div').attr('class', 'label ' + this._getSecondaryClassName()).html(function (d) {
                var value = _this5._getLabel(d);
                return value || value === false ? value : '(EMPTY)';
            });
        }
    }, {
        key: '_drawHoverBars',
        value: function _drawHoverBars(statData, width) {
            var _this6 = this;

            this.svg.selectAll('g.bg-rect').data(statData).enter().append('g').attr('class', 'hover').attr('transform', function (d) {
                return 'translate(0, ' + (_this6.yScale(_this6._getKey(d)) - 2) + ')';
            }).append('rect').attr('width', function () {
                return width;
            }).attr('height', this.yScale.rangeBand() + 4).attr('class', 'bg-rect').style('opacity', 0).on('mouseenter', function (d, i) {
                _d2.default.select(_d2.default.selectAll('rect.bg-rect')[0][i]).style('opacity', 0.4);
                _this6.tooltip.show(d, i);
            }).on('mouseleave', function (d, i) {
                _d2.default.select(_d2.default.selectAll('rect.bg-rect')[0][i]).style('opacity', 0);
                _this6.tooltip.hide(d);
            }).on('click', function (d) {
                var eventKeyPressed = { ctrlPressed: false, shiftPressed: false };

                if (_d2.default.event.ctrlKey || _d2.default.event.metaKey) {
                    eventKeyPressed.ctrlPressed = true;
                } else if (_d2.default.event.shiftKey) {
                    eventKeyPressed.shiftPressed = true;
                }

                _this6.onClick({ eventObject: { eventKeyPressed: eventKeyPressed, item: _extends({}, d) } });
            });
        }
    }, {
        key: '_renderWholeHBarchart',
        value: function _renderWholeHBarchart(firstVisuData, secondVisuData) {
        ...
        key: '_renderSecondaryBars',
        value: function _renderSecondaryBars(secondVisuData) {
            if (secondVisuData) {
    ...
    return ScHorizontalBarchartCtrl;
}();

exports.default = ScHorizontalBarchartCtrl;
...
var _listEditorController = __webpack_require__(165);

var _listEditorController2 = _interopRequireDefault(_listEditorController);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var ScListEditorComponent = {
    ...
    controller: _listEditorController2.default
};

exports.default = ScListEditorComponent;
...
var ScListEditorCtrl = function () {
	ScListEditorCtrl.$inject = ["$timeout", "$element"];
	function ScListEditorCtrl($timeout, $element) {
		'ngInject';

		_classCallCheck(this, ScListEditorCtrl);

		this.$timeout = $timeout;
		this.$element = $element;
	}

	_createClass(ScListEditorCtrl, [{
		key: '$onInit',
		value: function $onInit() {
			this.editMode = false;
			this.selectedIds = [];
		...
		key: 'renameItem',
		value: function renameItem(oldName, newName) {
			for (var i = 0; i < this.groups.length; i++) {
				for (var j = this.groups[i].items.length; j--;) {
		...
		value: function deleteItem(itemId) {
			...
			for (var _i = 0; _i < this.selectedIds.length; _i++) {
				if (this.selectedIds[_i].id == itemId) {
					this.selectedIds.splice(_i, 1);
				}
			}
		}
	}, {
		key: 'activateEdition',
		value: function activateEdition() {
			var _this = this;
			...
			this.$timeout(function () {
				var titleInput = _this.$element.find('input')[0];
				titleInput.focus();
			}, 0);
		}
	}, {
		key: 'validateEditon',
		value: function validateEditon() {
			if (this.editTitle !== '') {
		...
		key: 'onFilterKeyDown',
		value: function onFilterKeyDown(event) {
		...
		key: 'editModeKeyPressed',
		value: function editModeKeyPressed(event) {
		...
		key: 'getBadgeStyle',
		value: function getBadgeStyle(itemId) {
		...
		key: 'getBadgeIcon',
		value: function getBadgeIcon(itemId) {
		...
		key: 'getLabelById',
		value: function getLabelById(itemId) {
	...
	return ScListEditorCtrl;
}();

exports.default = ScListEditorCtrl;
...
var _qualityBarController = __webpack_require__(167);

var _qualityBarController2 = _interopRequireDefault(_qualityBarController);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var QualityBarComponent = {
    ...
    controller: _qualityBarController2.default,
    transclude: {
...
exports.default = QualityBarComponent;
...
var ScQualityBarCtrl = function () {
    ScQualityBarCtrl.$inject = ["$timeout"];
    function ScQualityBarCtrl($timeout) {
        'ngInject';

        _classCallCheck(this, ScQualityBarCtrl);

        this.MIN_QUALITY_WIDTH = 10;
        this.$timeout = $timeout;
    }

    _createClass(ScQualityBarCtrl, [{
        key: '$onInit',
        value: function $onInit() {
            this.refreshBars();
        }
        ...
        value: function $onChanges(changes) {
            ...
            var qualityCurrentValue = changes.quality.currentValue ? this.hashQuality(changes.quality.currentValue) : '';
            var qualityPreviousValue = changes.quality.previousValue ? this.hashQuality(changes.quality.previousValue) : '';
        ...
        key: 'refreshBarsWithAnimation',
        value: function refreshBarsWithAnimation() {
            var _this = this;
            ...
            this.$timeout(function () {
                ...
                _this.computeQualityWidth();
            }, 300);
        }
    }, {
        key: 'refreshBars',
        value: function refreshBars() {
        ...
        key: 'getMinimalPercent',
        value: function getMinimalPercent(type) {
            if (this.quality[type] <= 0) {
                return 0;
            }

            var percent = this.percent[type];
        ...
        key: 'getOrderedModifiableKeys',
        value: function getOrderedModifiableKeys(widthObject) {
            var _this2 = this;

            return Object.keys(widthObject).filter(function (key) {
                return widthObject[key] > _this2.MIN_QUALITY_WIDTH;
            }).sort(function (a, b) {
        ...
        key: 'callTranslate',
        value: function callTranslate(qualityValue) {
            var res = this.translateFn({ quality: qualityValue });
            return res;
        }
    }, {
        key: 'reduce',
        value: function reduce(widthObject, amount) {

            if (amount <= 0) {
                return;
            }

            var orderedKeys = this.getOrderedModifiableKeys(widthObject);
            if (amount <= 2) {
        ...
        key: 'computeQualityWidth',
        value: function computeQualityWidth() {
            var widthObject = {
        ...
        value: function computePercent() {
            var total = this.quality.empty + this.quality.invalid + this.quality.valid;
        ...
        key: 'hashQuality',
        value: function hashQuality(quality) {
            return quality.empty + '' + quality.invalid + '' + quality.valid;
        }
    }]);

    return ScQualityBarCtrl;
}();

exports.default = ScQualityBarCtrl;
...
var _slidableController = __webpack_require__(169);
...
var _splitterController = __webpack_require__(171);
...
var _tabsItem = __webpack_require__(173);
...
var ScTabsCtrl = function () {
    ...
    _createClass(ScTabsCtrl, [{
        ...
        value: function select(tab) {
            ...
            this.onTabChange({ tabIndex: tabIndex });
        }
    }, {
        key: 'setSelectedTab',
...
var _verticalBarchartController = __webpack_require__(177);

var _verticalBarchartController2 = _interopRequireDefault(_verticalBarchartController);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var ScVerticalBarchartComponent = {
    bindings: {
        onClick: '&',
        activeLimits: '<',
        keyField: '@',
    ...
    controller: _verticalBarchartController2.default
};

exports.default = ScVerticalBarchartComponent;
...
var ScVerticalBarchartCtrl = function () {
    ScVerticalBarchartCtrl.$inject = ["$element", "$attrs", "$timeout"];
    function ScVerticalBarchartCtrl($element, $attrs, $timeout) {
        'ngInject';

        _classCallCheck(this, ScVerticalBarchartCtrl);
    ...
    _createClass(ScVerticalBarchartCtrl, [{
        key: '$onInit',
        value: function $onInit() {
            var _this = this;

            this.tooltip = _d2.default.tip().attr('class', 'vertical-barchart-cls d3-tip').offset([0, -11]).direction('w').html(function (primaryDatum, index) {

                var tooltipValuePrimary = _this.primaryData[index].data;

                var tooltipValueSecondary = _this.secondaryData.find(function (obj) {
                    return obj.data.min === tooltipValuePrimary.min && obj.data.max === tooltipValuePrimary.max;
                });
                return _this.tooltipContent({
                    keyLabel: _this.keyLabel,
                    key: _this._getXAxisDomain(primaryDatum),
                    primaryValue: _this._getPrimaryValue(primaryDatum),
                    secondaryValue: tooltipValueSecondary ? _this._getSecondaryValue(tooltipValueSecondary) : "0"
                });
            });
        }
    }, {
        ...
        value: function $onChanges(changesObj) {
            ...
            if (firstDataHasChanged && firstVisuData) {
                ...
                _d2.default.selectAll('.vertical-barchart-cls.d3-tip').remove();
            ...
            if (changesObj.activeLimits) {
                ...
                this.updateLimitsTimeout = this.$timeout(function () {

                    _this2._updateBarsLookFeel();
                }, 500, false);
            }
        }
    }, {
        ...
        key: '_getXAxisDomain',
        value: function _getXAxisDomain(data) {
            return this._getRangeLabel(data) || this._getInterval(data);
        }
    }, {
        key: '_getInterval',
        value: function _getInterval(data) {
            var range = this._getRangeInfos(data);
            return [range.minLabel, range.maxLabel];
        }
    }, {
        key: '_getRangeInfos',
        value: function _getRangeInfos(data) {
            return data[this.keyField];
        }
    }, {
        key: '_getRangeLabel',
        value: function _getRangeLabel(data) {
            return data[this.keyField].label;
        }
    }, {
        key: '_getPrimaryValue',
        ...
        key: '_initChartSizes',
        value: function _initChartSizes() {
            this.margin = {
                top: 20,
                right: 20,
        ...
        value: function _initScales() {
            this.xScale = _d2.default.scale.ordinal().rangeRoundBands([0, this.width], 0.2);
            this.yScale = _d2.default.scale.linear().range([this.height, 0]);
        }
    }, {
        key: '_configureAxisScales',
        value: function _configureAxisScales(statData) {
            var _this3 = this;

            this.xScale.domain(statData.map(function (data) {
                return _this3._getXAxisDomain(data);
            }));
            this.yScale.domain([0, _d2.default.max(statData, function (data) {
                return _this3._getPrimaryValue(data);
            })]);
        }
    }, {
        ...
        value: function _createContainer() {
            this.svg = _d2.default.select(this.containerId).append('svg').attr('class', 'vertical-barchart-cls').attr('width', this.containerWidth).attr('height', this.containerHeight).append('g').attr('transform', 'translate(' + this.margin.left + ',' + this.margin.top + ')');
            this.svg.call(this.tooltip);
        }
    }, {
        key: '_createBarsContainers',
        ...
        key: '_adaptToMinHeight',
        value: function _adaptToMinHeight(realHeight) {
            return realHeight > 0 && realHeight < BAR_MIN_HEIGHT ? BAR_MIN_HEIGHT : realHeight;
        }
    }, {
        key: '_adaptToMinHeightYPosition',
        value: function _adaptToMinHeightYPosition(realYPosition) {
            var basePosition = this.yScale(0);
            var barHeight = this._adaptToMinHeight(basePosition - realYPosition);
        ...
        value: function _drawBars(containerClassName, statData, getValue, barClassName) {
            ...
            var bars = this.svg.select('.' + containerClassName).selectAll('.' + barClassName).data(statData, function (d) {
                return '' + _this4._getInterval(d);
            });

            bars.enter().append('rect').attr('class', barClassName).attr('x', function (d) {
                return _this4.xScale(_this4._getXAxisDomain(d));
            }).attr('width', this.xScale.rangeBand()).attr('y', function () {
                return _this4.yScale(0);
            }).attr('height', 0).transition().ease('cubic').delay(function (d, i) {
                return i * 10;
            }).attr('height', function (d) {
                var realHeight = _this4.height - _this4.yScale(getValue(d));
                return _this4._adaptToMinHeight(realHeight);
            }).attr('y', function (d) {
                var realYPosition = _this4.yScale(getValue(d));
                return _this4._adaptToMinHeightYPosition(realYPosition);
            });
        ...
        value: function _drawXAxis() {
            this.svg.append('g').attr('class', 'x axis').attr('transform', 'translate(0,' + this.height + ')').call(_d2.default.svg.axis().scale(this.xScale).orient('bottom').ticks(5)).selectAll('text').attr('y', 5).attr('x', -9).attr('dy', '.35em').style('text-anchor', 'end').attr('transform', 'rotate(295)');
        }
    }, {
        key: '_drawYAxis',
        value: function _drawYAxis() {
            this.svg.append('g').attr('class', 'yAxis').append('text').attr('x', -this.height / 2).attr('y', -2).attr('transform', 'rotate(-90)').style('text-anchor', 'middle').text(this.labelTooltip);
        }
    }, {
        key: '_drawHorizontalGrid',
        value: function _drawHorizontalGrid() {
            var minSizeBetweenGrid = 20;
            var ticksThreshold = Math.ceil(this.height / minSizeBetweenGrid);
            var ticksNbre = this.yScale.domain()[1] > ticksThreshold ? ticksThreshold : this.yScale.domain()[1];

            this.svg.append('g').attr('class', 'grid').call(_d2.default.svg.axis().scale(this.yScale).orient('right').tickSize(this.width, 0, 0).tickFormat(_d2.default.format(',d')).ticks(ticksNbre)).selectAll('.tick text').attr('y', -5).attr('x', this.width).attr('dy', '.15em').style('text-anchor', 'end');
        }
    }, {
        key: '_drawHoverBars',
        value: function _drawHoverBars(statData) {
            var _this5 = this;

            this.svg.selectAll('g.bg-rect').data(statData).enter().append('g').attr('class', 'hover').attr('transform', function (d) {
                return 'translate(' + (_this5.xScale(_this5._getXAxisDomain(d)) - 2) + ', 0)';
            }).append('rect').attr('width', this.xScale.rangeBand() + 4).attr('height', this.height).attr('class', 'bg-rect').style('opacity', 0).on('mouseenter', function (d, i) {
                _d2.default.select(_d2.default.selectAll('rect.bg-rect')[0][i]).style('opacity', 0.4);
                _this5.tooltip.show(d, i);
            }).on('mouseleave', function (d, i) {
                _d2.default.select(_d2.default.selectAll('rect.bg-rect')[0][i]).style('opacity', 0);
                ...
                var rangeInfo = _this5._getRangeInfos(d);
                _this5.onClick({ eventObject: { eventKeyPressed: eventKeyPressed, interval: _extends({}, rangeInfo) } });
            });
        }
    }, {
        key: '_renderWholeVBarchart',
        value: function _renderWholeVBarchart(firstVisuData, secondVisuData) {
            ...
            this.buckets = _d2.default.selectAll('rect.bar');
        }
    }, {
        key: '_renderSecondVBars',
        value: function _renderSecondVBars(secondVisuData) {
            if (secondVisuData) {
                this._drawBars('secondaryBar', secondVisuData, this._getSecondaryValue.bind(this), this._getSecondaryClassName());
            }
        }
    }, {
        key: '_updateBarsLookFeel',
        value: function _updateBarsLookFeel() {
            var _this6 = this;

            if (this.activeLimits) {
                this.buckets.transition().delay(function (d, i) {
                    return i * 10;
                }).style('opacity', function (d) {
                    var range = _this6._getRangeInfos(d);
                    var rangeMin = range.min;
                    var rangeMax = range.max;
                    var minLimit = _this6.activeLimits[0];
                    var maxLimit = _this6.activeLimits[1];
    ...
    return ScVerticalBarchartCtrl;
}();

exports.default = ScVerticalBarchartCtrl;
...
var _rangeFilterModel = __webpack_require__(182);

var _rangeFilterModel2 = _interopRequireDefault(_rangeFilterModel);

var _patternFilterModel = __webpack_require__(180);

var _patternFilterModel2 = _interopRequireDefault(_patternFilterModel);

var _qualityFilterModel = __webpack_require__(181);

var _qualityFilterModel2 = _interopRequireDefault(_qualityFilterModel);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

var FilterModelFactory = function () {
	function FilterModelFactory() {
		_classCallCheck(this, FilterModelFactory);
	}

	_createClass(FilterModelFactory, [{
		key: "createFilter",
		value: function createFilter(configuration) {
			if (configuration) {
				switch (configuration.type) {
					case _filterConst.FILTER_TYPE.COMPARE:
						break;
					case _filterConst.FILTER_TYPE.CONTAINS:
						break;
					case _filterConst.FILTER_TYPE.EMPTY_FILTER:
						break;
					case _filterConst.FILTER_TYPE.EXACT:
					case _filterConst.FILTER_TYPE.IN:

						if (configuration.options.values && configuration.options.values.length > 0) {

							return configuration.options.values.length > 1 ? new _inFilterModel2.default(configuration.fieldId, configuration.fieldName, configuration.options, configuration.editable) : new _exactFilterModel2.default(configuration.fieldId, configuration.fieldName, configuration.options, configuration.editable);
						}
						break;
					case _filterConst.FILTER_TYPE.INSIDE_RANGE:

						return new _rangeFilterModel2.default(configuration.fieldId, configuration.fieldName, configuration.options);
					case _filterConst.FILTER_TYPE.PATTERN:
						return new _patternFilterModel2.default(configuration.fieldId, configuration.fieldName, configuration.options, configuration.editable);
					case _filterConst.FILTER_TYPE.QUALITY:

						return new _qualityFilterModel2.default(configuration.fieldId, configuration.fieldName, configuration.options);
...
exports.default = FilterModelFactory;
...
var _filterModelFactory = __webpack_require__(178);

var _filterModelFactory2 = _interopRequireDefault(_filterModelFactory);
...
var FilterService = function () {
    function FilterService() {
        ...
        this.FilterModelFactory = new _filterModelFactory2.default();
        this.filterType = _filterConst.FILTER_TYPE;
    }

    _createClass(FilterService, [{
        key: 'updateFilter',
        value: function updateFilter(actualFilter, configuration) {
            var hasChanged = false;

            var result = actualFilter.map(function (filter) {
                var newFilter = filter.update(configuration);
            ...
            if (hasChanged) {
                ...
                var newFilter = this.FilterModelFactory.createFilter(configuration);
                return result.concat(newFilter);
            }
        }
    }, {
        key: 'removeFilter',
        value: function removeFilter(actualFilters, configuration) {
            var filter = configuration.filter;

            return actualFilters.filter(function (nextFilter) {
                return filter !== nextFilter;
            });
        }
    }, {
        key: 'addFilterValue',
        value: function addFilterValue(actualFilters, configuration) {
            var filter = configuration.filter,
                newValue = configuration.newValue;

            return actualFilters.map(function (nextFilter) {
        ...
        value: function updateFilterValue(actualFilters, configuration) {
            var filter = configuration.filter,
                oldValue = configuration.oldValue,
                newValue = configuration.newValue;
        ...
        key: 'removeFilterValue',
        value: function removeFilterValue(actualFilters, configuration) {
            var filter = configuration.filter,
        ...
        value: function toggleFilterValue(actualFilters, configuration) {
            var filter = configuration.filter,
                value = configuration.value;
...
var PatternFilter = function (_ScFilter) {
	_inherits(PatternFilter, _ScFilter);

	function PatternFilter(fieldId, fieldName, options, editable) {
		_classCallCheck(this, PatternFilter);

		var _this = _possibleConstructorReturn(this, (PatternFilter.__proto__ || Object.getPrototypeOf(PatternFilter)).call(this, fieldId, fieldName, options, editable));
	...
	_createClass(PatternFilter, [{
		...
		value: function toDSL() {
			...
			var valueToString = '';
			this.options.values.forEach(function (value, index) {
				valueToString += index !== _this2.options.values.length - 1 ? _this2.fieldId + " complies '" + value + "' or " : _this2.fieldId + " complies '" + value + "'";
			});
		...
		key: "update",
		value: function update(configuration) {
			if (configuration.fieldId === this.fieldId && configuration.type === _filterConst.FILTER_TYPE.PATTERN) {

				if (configuration.overwriteMode) {
					return new PatternFilter(this.fieldId, this.fieldName, configuration.options, configuration.editable);
				} else {
...
var INVALID_RECORDS_LABEL = 'invalid records';
var VALID_RECORDS_LABEL = 'valid records';

var QualityFilter = function (_ScFilter) {
	_inherits(QualityFilter, _ScFilter);

	function QualityFilter(fieldId, fieldName, options) {
		_classCallCheck(this, QualityFilter);

		var _this = _possibleConstructorReturn(this, (QualityFilter.__proto__ || Object.getPrototypeOf(QualityFilter)).call(this, fieldId, fieldName, options, false));

		_this.sign = 'quality';

		_this.options.values = [_this.options.isValid ? VALID_RECORDS_LABEL : INVALID_RECORDS_LABEL];
		return _this;
	}

	_createClass(QualityFilter, [{
		key: 'update',
		value: function update(configuration) {
			if (configuration.fieldId === this.fieldId && configuration.type === _filterConst.FILTER_TYPE.QUALITY) {
		...
		key: 'toggleFilterValues',
		value: function toggleFilterValues() {}
	}]);

	return QualityFilter;
}(_filterModel2.default);

exports.default = QualityFilter;
...
var RangeFilter = function (_ScFilter) {
    _inherits(RangeFilter, _ScFilter);

    function RangeFilter(fieldId, fieldName, options) {
        _classCallCheck(this, RangeFilter);

        var _this = _possibleConstructorReturn(this, (RangeFilter.__proto__ || Object.getPrototypeOf(RangeFilter)).call(this, fieldId, fieldName, options, false));

        _this.sign = 'inside_range';
    ...
    _createClass(RangeFilter, [{
        key: 'update',
        value: function update(configuration) {
            if (configuration.fieldId === this.fieldId && configuration.type === _filterConst.FILTER_TYPE.INSIDE_RANGE) {
                ...
                if (configuration.overwriteMode) {
                    ...
                    if (configuration.rangeMergeMode) {
                        ...
                        var newValue = this.mergeRangesWithCurrentOne(configuration.options.values);
                        configuration.options.values = newValue;
                    } else {
                        var _newValue = this.toggleFilterValues(configuration.options.values);
                        configuration.options.values = _newValue;
                    }
        ...
        key: 'mergeRangesWithCurrentOne',
        value: function mergeRangesWithCurrentOne(values) {
            var _this2 = this;

            var clone = JSON.parse(JSON.stringify(this.options.values));
            ...
            values.forEach(function (value) {
                if (clone[0].min > value.min) {
                    ...
                    (function () {
                        ...
                        if (!_this2.inAnotherRange(clone, newRange)) {

                            clone = _this2.removeDuplicateRange(clone, newRange);

                            if (!_this2.stepsOnCurrentRanges(clone, newRange)) {
                                clone.push(newRange);
                            } else {

                                var rangeToUpdate = clone.findIndex(function (filterValue) {
                ...
                clone.sort(_this2._compareValues);
            });
            return clone;
        }
    }, {
        key: 'inAnotherRange',
        value: function inAnotherRange(filterValues, range) {
            var rangeContainingValue = filterValues.filter(function (filterValue) {
        ...
        key: 'stepsOnCurrentRanges',
        value: function stepsOnCurrentRanges(filterValues, range) {
            var rangeContainingValue = filterValues.filter(function (filterValue) {
                return range.min > filterValue.min && range.min < filterValue.max || range.max < filterValue.max && range.max > filterValue.min;
            });
        ...
        key: 'removeDuplicateRange',
        value: function removeDuplicateRange(filterValues, range) {
            var rangeContainingValue = filterValues.filter(function (filterValue) {
        ...
        value: function removeValue(value) {
            ...
            var options = this.options;
            var newValues = this.options.values.filter(function (filterValue) {
                return _this3._compareValues(filterValue, value) !== 0;
            });
        ...
        value: function updateValue(oldValue, newValue) {
            ...
            var options = this.options;
            var newValues = JSON.parse(JSON.stringify(this.options.values));
            var updateIndex = newValues.findIndex(function (filterValue) {
                return _this4._compareValues(filterValue, oldValue) === 0;
            });

            if (updateIndex > -1) {
                var updatedValue = newValues.splice(updateIndex, 1)[0];
        ...
        value: function toggleValue(value) {
            var options = this.options;
            var newValue = this.toggleFilterValues([value]);
            var newOptions = _extends({}, options, {
                values: newValue
            });
            return this.setValues(newOptions);
        ...
        key: 'processMergeableRange',
        value: function processMergeableRange(filterList, value) {

            var previousRangeIndex = filterList.findIndex(function (filterValue) {
                return filterValue.max === value.min;
            });
            var nextRangeIndex = filterList.findIndex(function (filterValue) {
        ...
        value: function toDSL() {
            ...
            if (this.options.isSingleValueRange) {
                this.options.values.forEach(function (value, index) {
                    ...
                    stringToReturn += "(" + _this5.fieldId + " >= " + value.min + " and " + _this5.fieldId + " <= " + value.max + ")";
                    index !== _this5.options.values.length - 1 ? stringToReturn += ' or ' : '';
                });
            } else {
                this.options.values.forEach(function (value, index) {
                    stringToReturn += _this5.fieldId + " between [" + value.min + ", " + value.max + "]";
                    index !== _this5.options.values.length - 1 ? stringToReturn += ' or ' : '';
                });
            }
        ...
        value: function getLabel(value) {
            ...
            if (value[keyMin] !== value[keyMax]) {
                return !this.options.isSingleValueRange && !this.options.includeDateMax ? "[" + value[keyMin] + ", " + value[keyMax] + "[" : "[" + value[keyMin] + ", " + value[keyMax] + "]";
            }
        ...
        value: function toggleFilterValues(values) {
            ...
            values.forEach(function (value) {
                var index = clone.findIndex(function (filterValue) {
                    return _this6._compareValues(value, filterValue) === 0;
                });

                if (index > -1) {

                    clone.splice(index, 1);
                } else if (!_this6.stepsOnCurrentRanges(clone, value)) {
                    _this6.processMergeableRange(clone, value);
                } else {

                    if (_this6.inAnotherRange(clone, value) && !_this6.options.isSingleValueRange) {
                ...
                clone.sort(_this6._compareValues);
            });
            return clone;
        }
    }, {
        key: '_compareValues',
        value: function _compareValues(colA, colB) {
...
var _accordionModule = __webpack_require__(117);

var _accordionModule2 = _interopRequireDefault(_accordionModule);

var _datePickerModule = __webpack_require__(119);

var _datePickerModule2 = _interopRequireDefault(_datePickerModule);

var _dropdownMenuModule = __webpack_require__(120);

var _dropdownMenuModule2 = _interopRequireDefault(_dropdownMenuModule);

var _dropdownModule = __webpack_require__(121);

var _dropdownModule2 = _interopRequireDefault(_dropdownModule);

var _horizontalBarchartModule = __webpack_require__(128);

var _horizontalBarchartModule2 = _interopRequireDefault(_horizontalBarchartModule);

var _slidableModule = __webpack_require__(131);

var _slidableModule2 = _interopRequireDefault(_slidableModule);

var _splitterModule = __webpack_require__(132);

var _splitterModule2 = _interopRequireDefault(_splitterModule);

var _tabsModule = __webpack_require__(133);

var _tabsModule2 = _interopRequireDefault(_tabsModule);

var _verticalBarchartModule = __webpack_require__(134);

var _verticalBarchartModule2 = _interopRequireDefault(_verticalBarchartModule);

var _filterModule = __webpack_require__(135);

var _filterModule2 = _interopRequireDefault(_filterModule);

var _filterBarModule = __webpack_require__(122);

var _filterBarModule2 = _interopRequireDefault(_filterBarModule);

var _filterItemModule = __webpack_require__(123);

var _filterItemModule2 = _interopRequireDefault(_filterItemModule);

var _filterValueModule = __webpack_require__(125);

var _filterValueModule2 = _interopRequireDefault(_filterValueModule);

var _filterRangeModule = __webpack_require__(124);

var _filterRangeModule2 = _interopRequireDefault(_filterRangeModule);

var _filterListModule = __webpack_require__(126);

var _filterListModule2 = _interopRequireDefault(_filterListModule);

var _listEditorModule = __webpack_require__(129);

var _listEditorModule2 = _interopRequireDefault(_listEditorModule);

var _filterMonitorModule = __webpack_require__(127);

var _filterMonitorModule2 = _interopRequireDefault(_filterMonitorModule);

var _badgeModule = __webpack_require__(118);

var _badgeModule2 = _interopRequireDefault(_badgeModule);

var _qualityBarModule = __webpack_require__(130);

var _qualityBarModule2 = _interopRequireDefault(_qualityBarModule);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var SUNCHOKE_MODULE = 'talend.sunchoke';

_angular2.default.module(SUNCHOKE_MODULE, [_accordionModule2.default, _datePickerModule2.default, _dropdownMenuModule2.default, _dropdownModule2.default, _filterModule2.default, _horizontalBarchartModule2.default, _slidableModule2.default, _splitterModule2.default, _tabsModule2.default, _verticalBarchartModule2.default, _filterBarModule2.default, _filterItemModule2.default, _filterValueModule2.default, _filterRangeModule2.default, _filterListModule2.default, _filterMonitorModule2.default, _listEditorModule2.default, _badgeModule2.default, _qualityBarModule2.default]);
