...
describe('Tabs component', () => {
    ...
    it('should render tabs headers', () => {
        ...
        expect(element.find('.tabs-header').eq(0).text().trim()).toBe('tab 1 title');
        expect(element.find('.tabs-header').eq(1).text().trim()).toBe('tab 2 title');
        expect(element.find('.tabs-header').eq(2).text().trim()).toBe('tab 3 title');
    });
